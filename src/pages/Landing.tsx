  ...
  return (
    <main className="w-full mx-auto">
      ...
      <img
        src={cloud}
        alt=""
        className="absolute size-[720px] transform -scale-x-100 mx-auto mt-[-140px] ml-[15px] blur-[18px]"
      />
      <img
        src={cloud}
        alt=""
        className="absolute size-[1750px] mx-auto mt-[-230px] ml-[600px] blur-[5px] overflow-hidden"
      />
