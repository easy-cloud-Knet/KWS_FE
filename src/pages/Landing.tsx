...
const Landing = () => {
  ...
  return (
    <main className="w-full max-w-[1200px] mx-auto">
      ...
      <section className="flex flex-col items-center pt-[272px] pb-[322px]">
        <div className="absolute top-[2064px] left-[-170px] w-[2261px] h-[1272px] bg-[radial-gradient(ellipse_at_center,rgba(0,123,255,1),transparent_30%)] blur-[500px] pointer-events-none z-10" />
